				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="icon-box text-center hero-bg">
								<div class="service-icon">
									<img src="images/service/staff.png" alt="">
								</div>
								<h6>
									<a href="#">Staffing</a>
								</h6>
						...
						<div class="col-md-6 col-sm-12">
							<div class="icon-box text-center hero-bg">
								<div class="service-icon">
									<img src="images/service/hr.png" alt="">
								</div>
								<h6>
									<a href="#">HR</a>
								</h6>
						...
						<div class="col-md-6 col-sm-12">
							<div class="icon-box text-center hero-bg">
								<div class="service-icon">
									<img src="images/service/marketing.png" alt="">
								</div>
								<h6>
									<a href="#">Marketing</a>
								</h6>
						...
						<div class="col-md-6 col-sm-12">
							<div class="icon-box text-center hero-bg">
								<div class="service-icon">
									<img src="images/service/audit.png" alt="">
								</div>
								<h6>
									<a href="#">Auditing</a>
								</h6>
						...
						<div class="col-md-6 col-sm-12">
							<div class="icon-box text-center hero-bg">
								<div class="service-icon">
									<img src="images/service/tax.png" alt="">
								</div>
								<h6>
									<a href="#">Taxation</a>
								</h6>
