				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="icon-box text-center hero-bg">
								<div class="service-icon">
									<img src="images/service/service-icon-3.png" alt="">
								</div>
								<h6>
						...
						<div class="col-md-6 col-sm-12">
							<div class="icon-box text-center hero-bg">
								<div class="service-icon">
									<img src="images/service/service-icon-2.png" alt="">
								</div>
								<h6>
						...
						<div class="col-md-6 col-sm-12">
							<div class="icon-box text-center hero-bg">
								<div class="service-icon">
									<img src="images/service/service-icon-4.png" alt="">
								</div>
								<h6>
						...
						<div class="col-md-6 col-sm-12">
							<div class="icon-box text-center hero-bg">
								<div class="service-icon">
									<img src="images/service/service-icon-7.png" alt="">
								</div>
								<h6>
						...
						<div class="col-md-6 col-sm-12">
							<div class="icon-box text-center hero-bg">
								<div class="service-icon">
									<img src="images/service/service-icon-8.png" alt="">
								</div>
								<h6>
						...
						<div class="col-md-6 col-sm-12">
							<div class="icon-box text-center hero-bg">
								<div class="service-icon last">
									<img src="images/service/service-icon-9.png" alt="">
								</div>
								<h6>
									<a href="#">CMS</a>
								</h6>
						...
						<div class="col-md-12">
							...
							<div class="testimonials-slider owl-carousel" data-autoplay="false" data-responsive-lg="3" data-responsive-md="1" data-responsive-sm="1" data-nav="false" data-dots="true">
								...
								<div class="quote-item">
									...
									<p>
										This guys are awesome! It is hard to find a web design company who can actually listen and understand what you need.
									</p>
								</div>
								<div class="quote-item">
									<div class="testimonials-item">
