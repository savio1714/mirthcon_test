					...
					<ul class="slides">
						<li class="ds text-center slide1">
							...
							<span class="embed-responsive embed-responsive-16by9"> -->
								<!-- <iframe src="../../www.youtube.com/embed/UBufeh1yv2c409f.html?feature=oembed&amp;;showinfo=0&amp;;autoplay=1&amp;;controls=0&amp;;mute=1&amp;;loop=1&amp;;playlist=UBufeh1yv2c" allowfullscreen=""></iframe> -->
								<div class="img_main"> <img  src="images/main.jpg" alt=""> </div>
							</span>
							<div class="container">
								<div class="row">
					...
					<div class="row align-items-center c-mb-20 c-mb-lg-60">
						<div class="col-12 col-lg-4">
							<div class="step-left-part text-right">
								<h2 class="step-title">
									<span class="color-main">01</span>Planning</h2>
							</div>
						</div>
						<div class="col-12 col-lg-4">
						...
						<div class="col-12 col-lg-4  order-lg-3">
							<div class="step-left-part">
								<h2 class="step-title color1">
									<span class="color-main2">02</span> UI Design</h2>
							</div>
						</div>
